...
var WeatherUI = exports.WeatherUI = function () {
    function WeatherUI() {
        _classCallCheck(this, WeatherUI);
    ...
    _createClass(WeatherUI, [{
        key: 'alertMessage',
        value: function alertMessage(msg, className) {
            var _this = this;
        ...
        value: function clearAlert() {
            var currentAlert = document.querySelector('.alert-message');
            if (currentAlert) {
                currentAlert.remove();
            }
        }
        ...
        key: 'fromCelsiusToFahrenheit',
        value: function fromCelsiusToFahrenheit() {
            ...
            var cToFahr = Math.round(this.temp * 9 / 5 + 32);
        ...
        key: 'fromFahrenheitToCelsius',
        value: function fromFahrenheitToCelsius() {
            ...
            var fToCel = Math.round((this.temp - 32) * 5 / 9);
        ...
        key: 'toggleClassess',
        value: function toggleClassess(firstClassName, secondClassName) {
        ...
        key: 'sunSetAndSunriseTime',
        value: function sunSetAndSunriseTime(sunRise, sunSet) {
            //Getting time by sunrise and sunset utc code
            var sunR = this.convertTimeFromUTC(sunRise);
            var sunS = this.convertTimeFromUTC(sunSet);
        ...
        key: 'convertTimeFromUTC',
        value: function convertTimeFromUTC(utc) {
        ...
        value: function addBackgroundImage() {
            var date = new Date();
            //Check for current hours if it between 6am and 18pm set day background image, otherwise set night.
            date.getHours() > 6 && date.getHours() < 18 ? this.body.style.backgroundImage = 'url("images/day.jpg")' : this.body.style.backgroundImage = 'url("images/night.jpg")';
        }
    }]);
...
var _weatherUI = __webpack_require__(125);

var _getGeolocation = __webpack_require__(330);

var _weatherDataByGeolocation = __webpack_require__(331);

var _weatherDataByCityName = __webpack_require__(332);

//Make instance of weatherUI class
var newWeatherUI = new _weatherUI.WeatherUI();
...
function getWeatherByLocation() {
    ...
    var geolocator = new _getGeolocation.Geolocater();
    ...
    geolocator.getCurrentPosition().then(function (coordinates) {
        ...
        var weatherDataByLocation = new _weatherDataByGeolocation.GetWeatherByLocation(coordinates.latitude, coordinates.longitude);

        //4. Getting data from Api server by geolocation and display on UI
        weatherDataByLocation.get().then(function extractData(results) {
            // console.log(results);
            newWeatherUI.display(results);

            //Toggle active class on click of units type
            newWeatherUI.unitsType.forEach(function (unit) {
                return unit.addEventListener('click', switchBetweenUnits);
            });
...
function getWeatherByCity() {
    ...
    var cityName = newWeatherUI.cityInput.value;

    //2.If city name value is true continue
    if (cityName) {

        //3.Make new instance and pass values
        var weatherByCityName = new _weatherDataByCityName.GetWeatherByCityName(cityName);

        //4.Recieve data and display it on UI
        weatherByCityName.get().then(function extractData(results) {
            // console.log(results);
            newWeatherUI.display(results);
...
var Geolocater = exports.Geolocater = function () {
  function Geolocater() {
    _classCallCheck(this, Geolocater);
  ...
  _createClass(Geolocater, [{
    key: 'geolocationIsAvailable',
    value: function geolocationIsAvailable() {
    ...
    key: 'geolocationIsNotAvailable',
    value: function geolocationIsNotAvailable() {
    ...
    value: function getCurrentPosition() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this.navigator.geolocation.getCurrentPosition(positionSuccess, error, { enableHighAccuracy: true });
      });
    }
  }]);
...
var GetWeatherByLocation = function () {
    function GetWeatherByLocation(latitude, longtitude) {
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return fetch("https://api.openweathermap.org/data/2.5/weather?lat=" + this.latitude + "&lon=" + this.longtitude + "&appid=" + this.apiKey + "&units=metric");
...
var GetWeatherByCityName = function () {
    function GetWeatherByCityName(city) {
        _classCallCheck(this, GetWeatherByCityName);
    ...
    _createClass(GetWeatherByCityName, [{
        key: "get",
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                var response, responseData;
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return fetch("https://api.openweathermap.org/data/2.5/weather?q=" + this.city + "&appid=" + this.apiKey + "&units=metric");
